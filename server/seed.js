...
const services = [
  {
    ...
    short_desc: "Professional staff for immaculate facility maintenance.",
    long_desc: "Our housekeeping staff is trained in modern cleaning techniques, safety protocols, and guest relations to ensure your facility remains pristine at all times.",
    highlights: [
    ...
    icon_name: "Users",
    image_url: "/images/housekeeping.png"
  },
  {
    title: "Industrial Production Support",
    short_desc: "Skilled manpower for assembly lines and factory floors.",
    long_desc: "Staff trained in industrial safety, machine operations assistance, and production line efficiency. We ensure our staff adheres to your specific SOPs.",
    highlights: [
    ...
    icon_name: "UserCheck",
    image_url: "/images/production_support.png"
  },
  {
    title: "Corporate Pantry & Hospitality",
    short_desc: "Dedicated staff for corporate pantry and refreshments.",
    long_desc: "Professional pantry staff trained in hygiene, food handling, and corporate etiquette to manage your office refreshments and hospitality needs.",
    highlights: [
    ...
    icon_name: "Coffee",
    image_url: "/images/pantry.png"
  },
  {
    title: "Laboratory Technical Assistance",
    short_desc: "Support staff for laboratory and technical testing areas.",
    long_desc: "Assisting technicians in material handling, equipment cleaning, and sample management with strict adherence to safety and hygiene protocols.",
    highlights: [
    ...
    icon_name: "Search",
    image_url: "/images/lab_technical_assistance.png"
  },
  {
    title: "Packaging & Logistics Personnel",
    short_desc: "Reliable staff for packing, sorting, and logistics.",
    long_desc: "Trained packing and sorting workforce to support your warehouse and logistics operations with speed, accuracy, and consistency.",
    highlights: [
    ...
    icon_name: "Package",
    image_url: "/images/packing.png"
  },
  {
    title: "Security & Surveillance (CCTV)",
    short_desc: "Comprehensive CCTV installation and network surveillance solutions.",
    long_desc: "Professional end-to-end security solutions including strategic camera placement, advanced network configuration, and high-definition monitoring systems.",
    highlights: [
    ...
    icon_name: "Camera",
    image_url: "/images/cctv_installation.png"
  },
  {
    title: "Electrical & Technical Maintenance",
    short_desc: "Skilled technicians for electrical and facility maintenance.",
    long_desc: "Preventive maintenance, wiring repairs, fixture installations, and specialized filter cleaning for industrial and commercial systems.",
    highlights: [
    ...
    icon_name: "Zap",
    image_url: "/images/electrical.png"
  },
  {
    title: "HVAC Operations & Management",
    short_desc: "Air conditioning operations and preventive maintenance.",
    long_desc: "Our AC technicians handle everything from routine servicing to emergency repairs, ensuring optimal climate control in your facility.",
    highlights: [
    ...
    icon_name: "Fan",
    image_url: "/images/hvac.png"
  }
];

async function seed() {
  console.log('Seeding existing services...');
